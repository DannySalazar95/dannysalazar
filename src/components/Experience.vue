<template>
    <div id="experience" class="flex flex-wrap w-full md:w-3/5 md:mx-auto py-5 overflow-x-auto">
        ...
        <div class="w-full flex flex-col">
            <div v-for="({company, logo,description,link,work_dates},index) in works" :key="index" class="w-full border border-gray-400 bg-white p-4 flex flex-col justify-between leading-normal mb-1">
                <div class="mb-8">
                    <p class="text-sm text-gray-600 text-right">{{company}}</p>
                    <img class="mb-2" :src="logo.url" :alt="company" :width="logo.width" :height="logo.height">
                    <hr>
                    ...
                    <vue-markdown class="text-gray-700 text-base">{{description}}</vue-markdown>
